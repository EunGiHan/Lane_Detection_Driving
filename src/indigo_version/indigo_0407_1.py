...
class Houghline_Detect:
    ...
    def drive(self, Angle, Speed):
        ...
        msg.angle = int(Angle)              # TODO : int 계속 처리할 거야????
    ...
    def process_image(self, frame):
        ...
        roi = edge_img[51: self.Gap, :]
                    ...
                    # #전체 합으로 나누는 cv2.NORM_L1 / 단위 벡터로 정규화하는 cv2.NORM_L2 / 최댓값으로 나누는 cv2.NORM_INF
                    # norm = cv2.normalize(gray, None, 0, 255, cv2.NORM_MINMAX)
    ...
    def start(self):
        ...
        while True:
            ...
            if cv2.waitKey(1) & 0xFF == ord('p'):
                if cv2.waitKey() & 0xFF == ord('q'):    # pause 기능
                    break
